<template>
  <div>
        ...
        <div class="content-left"  @click="clickShow">
          <div class="logo-wrapper">
            <div class="logo" :class="{highlight: totalCount>0}" >
              <i class="iconfont icon-lvsefenkaicankaoxianban-10 highlight"></i>
            </div>
        ...
        <div class="shopcart-list" v-show="listShow">
          <div class="list-header">
            ...
            <div class="list-content" ref="food" >
              <ul>
                <li class="food" v-for="(f,i) in cartFoods" :key="f.name">
                  <span class="name">{{f.name}}</span>
                  <div class="price"><span>￥{{f.price}}</span></div>
    ...
    <transition name="fade">
      <div class="list-mask" v-show="listShow" @click="clickShow" style="display: none"></div>
    </transition>
  </div>
</template>
  ...
  computed: {
    ...
    listShow(){
      ...
      if(this.isShow){
        this.$nextTick(()=>{
          if(!this.BS_food){
            this.BS_food = new BS(this.$refs.food,{
              click:true
            })
          }else{
            this.BS_food.refresh();
          }
        })
      }
      return this.isShow
      ...
      .content-left
        ...
        .logo-wrapper
          ...
          .logo
            ...
            &.highlight
              background: $green
            .icon-lvsefenkaicankaoxianban-10
              line-height: 44px
              font-size: 24px
              color: #80858a
              &.highlight
