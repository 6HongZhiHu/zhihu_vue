  ...
  <div class="shop-header">
    ...
    <div class="shop-header-discounts" v-if="info.supports" @click="isShowSupports = true">
      <div class="discounts-left">
        <div class="activity" :class="subCls[info.supports[0].type]">
          <span class="content-tag">
      ...
      <div class="shop-brief-modal" v-show="isShowBulletin">
        <div class="brief-modal-content">
          ...
          <div class="mask-footer" @click="isShowBulletin = false">
            <i class="iconfont icon-lvsefenkaicankaoxianban-18"></i>
          </div>
        </div>
        ...
        <div class="activity-sheet-content">
          ...
          <ul class="list">
            <li 
              class="activity-item"
              :class="subCls[s.type]"
              v-for="(s,index) in info.supports" :key="index"
            >
              <span class="content-tag">
...
export default {
  ...
  data() {
    //这里存放数据
    return {
      subCls:["activity-green","activity-red","activity-orange"],
